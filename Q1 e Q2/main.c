...
/*2. Seja o seguinte trecho de programa:
  ...
  **&p;
  ...
  "3 - *p/(*q) + 7" será igual a 10, porque ele realizará a operação 3 - 0 + 7. Isso se deve 
  ao fato que foi realizada uma divisão resultante menor que 1, fazendo com que o compilador
  dê o cast do valor em inteiro. Isso faz com que 3/5 resulte em 0 e a operação seja "3 - 0 + 7".
