...
/*10. Seja x um vetor de 4 elementos, declarado da forma TIPO x[4];. Suponha que depois da
      ...
      Suponha também que na máquina seja usada uma variável do tipo char ocupa 1 byte, do tipo int
      ocupa 2 bytes, do tipo float ocupa 4 bytes e do tipo double ocupa 8 bytes. Quais serão os
  ...
  11. Implemente um programa de computador para testar estas suposições e compare as respostas
